...
[![hexlet-check](https://github.com/Abdujabbar/devops-engineer-from-scratch-project-318/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Abdujabbar/devops-engineer-from-scratch-project-318/actions)
...
```bash
git clone https://github.com/Abdujabbar/devops-engineer-from-scratch-project-318.git
